...
pub fn Vec3(comptime T: type) type {
    return struct {
        ...
        pub inline fn project(self: Self, onto: Self) Self {
            ...
            const onto_mag_sq = onto.magnitudeSquared();
            if (onto_mag_sq == 0) return zero;
            return onto.scale(dot_product / onto_mag_sq);
        }
