...
pub const Font = struct {
    ...
    weight: FontWeight,
    texture_id: u32,
    glyph_map: HashMap(u32, Glyph, std.hash_map.AutoContext(u32)),
    line_height: f32,
    ascent: f32,
    descent: f32,
...
pub const GPUAcceleratedGUI = struct {
    ...
    widgets: HashMap(u32, *Widget, std.hash_map.AutoContext(u32)),
    next_widget_id: u32,
    fonts: HashMap(u32, Font, std.hash_map.AutoContext(u32)),
    textures: HashMap(u32, Texture, std.hash_map.AutoContext(u32)),
    focused_widget: ?u32,
    hovered_widget: ?u32,
    cursor: Cursor,
    theme: Theme,
    ...
    pub fn init(allocator: Allocator, screen_width: f32, screen_height: f32) !GPUAcceleratedGUI {
        return GPUAcceleratedGUI{
            ...
            .widgets = HashMap(u32, *Widget, std.hash_map.AutoContext(u32)).init(allocator),
            .next_widget_id = 1,
            .fonts = HashMap(u32, Font, std.hash_map.AutoContext(u32)).init(allocator),
            .textures = HashMap(u32, Texture, std.hash_map.AutoContext(u32)).init(allocator),
            .focused_widget = null,
            .hovered_widget = null,
            .cursor = .arrow,
            .theme = Theme{},
    ...
    pub fn loadFont(self: *GPUAcceleratedGUI, path: []const u8, size: f32) !u32 {
        ...
        const font = Font{
            ...
            .weight = .normal,
            .texture_id = 0,
            .glyph_map = HashMap(u32, Font.Glyph, std.hash_map.AutoContext(u32)).init(self.allocator),
