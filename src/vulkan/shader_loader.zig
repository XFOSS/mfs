...
pub const ShaderLoader = struct {
    allocator: Allocator,
    shader_cache: std.HashMap(u64, CompiledShader, std.hash_map.DefaultContext(u64), std.hash_map.default_max_load_percentage),
    ...
    pub fn init(allocator: Allocator) Self {
        return Self{
            .allocator = allocator,
            .shader_cache = std.HashMap(u64, CompiledShader, std.hash_map.DefaultContext(u64), std.hash_map.default_max_load_percentage).init(allocator),
        };
    }
