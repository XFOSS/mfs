...
pub fn build(b: *std.Build) void {
    ...
    const emcc = b.addSystemCommand(&[_][]const u8{
        ...
        "WASM=1",
        "-s",
        "EXPORTED_FUNCTIONS=['_initialize_spinning_cube_demo','_start_spinning_cube_demo','_pause_spinning_cube_demo','_reset_spinning_cube_demo','_web_resize']",
        "-s",
